...
using ReactAli2017.ServerDef.Models;
using ReactAli2017.ServerDef.Services;
using ReactAli2017.Server.SqlDb;
using System.Data.SqlClient;
using ReactAli2017.Server;

namespace ReactAli2017
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          services.AddTransient<IQueryPipe>(_ => new QueryPipe(new SqlConnection(Configuration.GetConnectionString("DefaultConnection"))));
          services.AddTransient<ICommand>(_ => new Command(new SqlConnection(Configuration.GetConnectionString("DefaultConnection"))));
